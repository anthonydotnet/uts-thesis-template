...
% set table and figure text spacing
...
\tikzstyle{process} = [rectangle, minimum width=3.25cm, minimum height=1.3cm, line width=1pt, text centered, text width=3.25cm, draw=blue!30, fill=blue!15, align=center,
    font=\linespread{0.9}\tiny]
...
\tikzstyle{decision} = [diamond, aspect=1.75, minimum width=3cm, minimum height=0.5cm, line width=1pt, text centered, text width=3.0cm, draw=yellow!60, fill=yellow!40, font=\linespread{0.9}\tiny]
